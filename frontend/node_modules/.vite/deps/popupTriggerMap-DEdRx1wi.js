...
import { _ as isShadowRoot, f as isElement, h as isNode, l as getParentNode, m as isLastTraversableNode, n as getComputedStyle, o as getNodeName, p as isHTMLElement, t as useStableCallback } from "./useStableCallback-C4GnjBQq.js";
import { t as useIsoLayoutEffect } from "./useIsoLayoutEffect-XBfELL_r.js";
import { a as isReactVersionAtLeast, i as NOOP, r as EMPTY_OBJECT, s as useRefWithInit, t as useRenderElement } from "./useRenderElement-Gy55rVqn.js";
import { h as TransitionStatusDataAttributes, i as useTransitionStatus, l as isElementVisible, m as useOnMount, n as useOpenChangeComplete } from "./inertValue-CPVB0gNM.js";
import { _ as outsidePress, a as createChangeEventDetails, b as triggerPress, g as none, i as getTarget, l as escapeKey, n as activeElement, r as contains, t as ownerDocument, y as triggerHover } from "./owner-BOc0Z-wO.js";
import { n as useId } from "./useBaseUiId-BM8ExPIN.js";
import { t as visuallyHidden } from "./visuallyHidden-wgUduBIR.js";
...
//#endregion
export { isMouseLikePointerType as $, POPUP_COLLISION_AVOIDANCE as A, FocusGuard as B, useFloatingTree as C, CLICK_TRIGGER_IDENTIFIER as D, usePortalContext as E, getNextTabbable as F, isTargetInsideEnabledTrigger as G, addEventListener as H, getPreviousTabbable as I, matchesFocusVisible as J, isTypeableCombobox as K, isOutsideEvent as L, getNodeAncestors as M, getNodeChildren as N, DISABLED_TRANSITIONS_STYLE as O, focusable as P, ARROW_UP as Q, isTabbable as R, useFloatingParentNodeId as S, useFloatingPortalNode as T, getFloatingFocusElement as U, mergeCleanups as V, isInteractiveElement as W, ARROW_LEFT as X, ARROW_DOWN as Y, ARROW_RIGHT as Z, fastComponent as _, setPopupOpenState as a, ios as at, useOnFirstRender as b, useOpenStateTransitions as c, useTimeout as ct, usePopupStore as d, popupStateMapping as dt, isVirtualClick as et, useTriggerDataForwarding as f, pressableTriggerOpenStateMapping as ft, useStore as g, Store as h, createDefaultInitialFocus as i, webkit as it, createAttribute as j, DROPDOWN_COLLISION_AVOIDANCE as k, usePopupInteractionProps as l, CommonPopupDataAttributes as lt, ReactStore as m, FOCUSABLE_POPUP_PROPS as n, stopEvent as nt, useImplicitActiveTrigger as o, mac as ot, FloatingRootStore as p, triggerOpenStateMapping as pt, isTypeableElement as q, applyPopupOpenChange as r, jsdom as rt, useInitialOpenSync as s, Timeout as st, PopupTriggerMap as t, isVirtualPointerEvent as tt, usePopupRootSync as u, CommonTriggerDataAttributes as ut, fastComponentRef as v, FloatingPortal as w, useDismiss as x, createSelector as y, tabbable as z };
