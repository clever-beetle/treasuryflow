...
import { f as isElement, p as isHTMLElement, t as useStableCallback, u as getWindow } from "./useStableCallback-C4GnjBQq.js";
import { t as useIsoLayoutEffect } from "./useIsoLayoutEffect-XBfELL_r.js";
import { i as NOOP, r as EMPTY_OBJECT, s as useRefWithInit, t as useRenderElement } from "./useRenderElement-Gy55rVqn.js";
import { r as mergeProps } from "./merge-props-B1zstas5.js";
import { g as transitionStatusMapping, m as useOnMount, n as useOpenChangeComplete, p as useAnimationFrame, r as useAnimationsFinished, t as inertValue } from "./inertValue-CPVB0gNM.js";
import { $ as isMouseLikePointerType, A as POPUP_COLLISION_AVOIDANCE, C as useFloatingTree, G as isTargetInsideEnabledTrigger, H as addEventListener, J as matchesFocusVisible, N as getNodeChildren, S as useFloatingParentNodeId, T as useFloatingPortalNode, V as mergeCleanups, W as isInteractiveElement, _ as fastComponent, c as useOpenStateTransitions, ct as useTimeout, d as usePopupStore, dt as popupStateMapping, f as useTriggerDataForwarding, it as webkit, j as createAttribute, l as usePopupInteractionProps, m as ReactStore, n as FOCUSABLE_POPUP_PROPS, o as useImplicitActiveTrigger, ot as mac, pt as triggerOpenStateMapping, q as isTypeableElement, r as applyPopupOpenChange, s as useInitialOpenSync, st as Timeout, t as PopupTriggerMap, ut as CommonTriggerDataAttributes, v as fastComponentRef, x as useDismiss, y as createSelector } from "./popupTriggerMap-DEdRx1wi.js";
import { a as createChangeEventDetails, b as triggerPress, c as disabled, d as imperativeAction, g as none, i as getTarget, n as activeElement, r as contains, t as ownerDocument, v as triggerFocus, y as triggerHover } from "./owner-BOc0Z-wO.js";
import { t as useBaseUiId } from "./useBaseUiId-BM8ExPIN.js";
import { r as useValueAsRef } from "./visuallyHidden-wgUduBIR.js";
import { t as useDirection } from "./DirectionContext-BMoNo9M2.js";
import { a as usePreviousValue, i as adaptiveOrigin, n as getDisabledMountTransitionStyles, r as useAnchorPositioning, t as usePositioner } from "./usePositioner-DXwo3cKT.js";
import { n as createPopupFloatingRootContext, r as popupStoreSelectors, t as createInitialPopupStoreState } from "./store-CKoBTO0C.js";
import { t as getCssDimensions } from "./getCssDimensions-Br8La2Xw.js";
...
function TooltipInteractions({ store, disabled, trackCursorAxis }) {
	...
	const activeTriggerProps = import_react.useMemo(() => mergeProps(clientPoint.reference, dismiss.reference), [clientPoint.reference, dismiss.reference]);
	const inactiveTriggerProps = import_react.useMemo(() => mergeProps(clientPoint.trigger, dismiss.trigger), [clientPoint.trigger, dismiss.trigger]);
	const popupProps = import_react.useMemo(() => mergeProps(FOCUSABLE_POPUP_PROPS, clientPoint.floating, dismiss.floating), [clientPoint.floating, dismiss.floating]);
